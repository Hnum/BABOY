...
import youtube_dl
#=============
cl = LineClient(authToken='EwuDzAX1HOChhzFJMivb.Sp/s6yipA4kI8lGDz1Jc/W./IDEYRL3fL3zmq9ikK8ECpVJH4UzuQa9BsSXAgUOX+U=')
...
wait = {
    ...
    "dellbots":False,
    "blacklist":{
        "ub0ff92e9820f6b82a2f0b81d6758c2fb": True
    },
    "wblacklist":False,
    "dblacklist":False,
    "Talkblacklist":{},
    ...
    "unsend":False,
    "mention":"tadi ngintip sekarang ngecheck..",
    "Respontag":"Sekarang tag besok jatuh cinta...amiin ",
    "welcome":"Welcome...",
    "leave":"See you next againt later...",
    "comment":"Super Like by: ʙᴜᴋᴀɴ ʙᴏᴛ™",
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Haii ", ", terimakasih sudah add saya sudah ku add back ya.")
                  ...
                  if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if invite in wait["blacklist"]:
                            cl.sendMessage(msg.to, "「Dia masuk daftar bl... harus hapus dr daftar bl dulu lalu invite lagi」")
                            break
                        else:
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「↻ɾҽąէҽժ ҍվ :  ᴄᴀʟᴏɴ ᴀʟᴍᴀʀʜᴜᴍ️ 」") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    zx2.append(zx)
                                    zxc += pesan2
                                    text = xpesan+zxc + "「See U next Later」" 
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               cl.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ 「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎"),
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               ki.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ 「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kk.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ 「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kc.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ 「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               km.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ ︎「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎")
                            ...
                            if msg._from in admin:
                               ...
                               for i in gid:
                                   ...
                                   ma += "╠ " + str(a) + ". " +G.name+ "\n"
                               kb.sendMessage(msg.to,"╔▬▬▬❒︎ɢʀᴏᴜᴘ ʟɪꜱᴛ❒︎\n║\n"+ma+"║\n╚▬▬▬❒︎ ᴛᴏᴛᴀʟ ︎「"+str(len(gid))+"」ɢʀᴏᴜᴘꜱ ❒︎")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                start = time.time()
                                sw.sendText("u0af57803f3c7b67a851ab987c9c31af6", '.')
                                elapsed_time = time.time() - start
